 ...
 * when this programme is executed). Input
 * 
 ...
 * written in any order. Output
 * 
 * Print a single integer — the final value of x. Sample test(s) Input
 * 
 * 1 ++X
 * 
 * Output
