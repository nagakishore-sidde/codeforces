 ...
 * problems for which they will write a solution. Input
 * 
 ...
 * Tonya's view. The numbers on the lines are separated by spaces. Output
 * 
 * Print a single integer — the number of problems the friends will implement on
 * the contest. Sample test(s) Input
 * 
 * 3 1 1 0 1 1 1 1 0 0
 * 
 * Output
